...
export function LessonModal({ completed, lesson, onClose, onComplete }: LessonModalProps) {
  ...
  return (
    <Modal animationType="slide" onRequestClose={onClose} visible={Boolean(lesson)}>
      <SafeAreaView edges={['top', 'bottom']} style={styles.safeArea}>
        {lesson && (
          <View style={styles.screen}>
            <View style={styles.header}>
              <Pressable accessibilityLabel="Close lesson" accessibilityRole="button" onPress={onClose} style={styles.iconButton}>
