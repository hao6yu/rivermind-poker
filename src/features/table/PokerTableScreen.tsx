  ...
  return (
    <View style={styles.screen}>
      ...
      <LinearGradient colors={[palette.table, palette.tableDeep]} style={styles.table}>
        ...
        <View style={styles.playerZone}>
          <View style={styles.cardsRow}>
            {game.players.hero.holeCards.map((card) => <PlayingCard card={card} key={cardLabel(card)} />)}
          </View>
      ...
      {coachEnabled && game.street !== 'complete' && heroTurn && (
        <View style={styles.coachBar}>
          ...
          <Pressable accessibilityRole="button" onPress={() => setInsightVisible(true)} style={styles.hintButton}>
          ...
          <View style={styles.reviewSheet}>
            <View style={styles.reviewHeader}>
              <View>
                ...
                <Text style={styles.reviewTitle}>Coach notes</Text>
              </View>
          ...
          <View style={styles.reviewSheet}>
            <View style={styles.reviewHeader}>
              <View>
                ...
                <Text style={styles.reviewTitle}>Your decision</Text>
              </View>
...
function createStyles(palette: ThemePalette) {
  return StyleSheet.create({
    screen: { flex: 1, backgroundColor: palette.background, paddingHorizontal: 14, paddingTop: 8, paddingBottom: 6, gap: 10 },
    ...
    table: { flex: 1, minHeight: 390, borderRadius: 128, borderWidth: 1, borderColor: palette.tableLine, paddingVertical: 20, paddingHorizontal: 12, justifyContent: 'space-between', overflow: 'hidden', shadowColor: palette.shadow, shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.18, shadowRadius: 24, elevation: 5 },
    tableRing: { position: 'absolute', top: 6, right: 6, bottom: 6, left: 6, borderRadius: 122, borderWidth: 1, borderColor: palette.tableLine },
    playerZone: { alignItems: 'center', gap: 6, zIndex: 1 },
    playerName: { color: palette.tableText, fontSize: 11, fontWeight: '700' },
    cardsRow: { flexDirection: 'row', gap: 5 },
    centerZone: { alignItems: 'center', gap: 12, zIndex: 1 },
