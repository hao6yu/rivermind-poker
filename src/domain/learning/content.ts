  ...
  questions: [
    {
      ...
      choices: [{ id: 'a', label: '9%' }, { id: 'b', label: '19%' }, { id: 'c', label: '36%' }],
      correctChoiceId: 'b',
    ...
    },
    {
      ...
      choices: [{ id: 'a', label: '19%' }, { id: 'b', label: '27%' }, { id: 'c', label: '35%' }],
      correctChoiceId: 'c',
    ...
    },
    {
      ...
      choices: [{ id: 'a', label: '20%' }, { id: 'b', label: '25%' }, { id: 'c', label: '33%' }],
      correctChoiceId: 'b',
    ...
    },
    {
      ...
      choices: [{ id: 'a', label: '25%' }, { id: 'b', label: '30%' }, { id: 'c', label: '43%' }],
      correctChoiceId: 'b',
    ...
    },
    {
      ...
      choices: [{ id: 'a', label: '9%' }, { id: 'b', label: '17%' }, { id: 'c', label: '32%' }],
      correctChoiceId: 'b',
  ...
  questions: [
    {
      ...
      choices: [{ id: 'a', label: 'Fold' }, { id: 'b', label: 'Call only' }, { id: 'c', label: 'Raise' }],
      correctChoiceId: 'c',
    ...
    },
    {
      ...
      choices: [{ id: 'a', label: 'Fold' }, { id: 'b', label: 'Call' }, { id: 'c', label: 'Raise' }],
      correctChoiceId: 'a',
    ...
    },
    {
      ...
      choices: [{ id: 'a', label: 'Check automatically' }, { id: 'b', label: 'Bet small for value' }, { id: 'c', label: 'Move all-in' }],
      correctChoiceId: 'b',
    ...
    },
    {
      ...
      choices: [{ id: 'a', label: 'Check' }, { id: 'b', label: 'Bet because you missed' }, { id: 'c', label: 'Always overbet' }],
      correctChoiceId: 'a',
