...
const roster = [
  ...
  { id: 'milo-balanced', name: 'Milo', style: 'balanced', level: 'friendly' },
  { id: 'elsa-sticky', name: 'Elsa', style: 'sticky', level: 'friendly' },
  { id: 'otto-pressure', name: 'Otto', style: 'pressure', level: 'friendly' },
  ...
  { id: 'noah-deceptive', name: 'Noah', style: 'deceptive', level: 'club' },
